...
\begin{frame}{Goal and Scope}
  \begin{itemize}
    ...
    \item Dataset: official CNE Autarquicas 2021 spreadsheet package.
  ...
  \begin{itemize}
    ...
    \item Triggers enforce meaningful business rules:
      \begin{itemize}
        ...
        \item voters cannot exceed registered voters;
  ...
  \begin{itemize}
    ...
    \item Loaded geometry coverage:
      \begin{itemize}
        ...
        \item parish: 2949 / 3083.
      \end{itemize}
    \item Frontend includes election/organ selection, interactive Leaflet municipality map, result table, turnout summary, vote-share chart, and seat chart.
  \end{itemize}
\end{frame}
...
\begin{frame}{Limitations and Extensions}
  \begin{itemize}
    ...
    \item Parish geometries are partial because some codes changed between 2021 and 2025.
    \item Some elected-member rows do not match normalized parish candidacies exactly.
    \item Future work: historical comparisons, richer district dashboards, and improved parish reconciliation.
  \end{itemize}
\end{frame}
